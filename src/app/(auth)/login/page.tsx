    ...
    <section className="mx-auto flex w-full max-w-md flex-col gap-6 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
      <header className="flex flex-col gap-1 text-center">
        ...
        <p className="text-sm text-slate-600">
          Acceso seguro para entrenadores, atletas y staff. Funciona offline con
          datos sincronizados.
        </p>
      </header>
      ...
      <footer className="text-center text-xs text-slate-500">
        Consejo: si estás offline, asegúrate de haber iniciado sesión
        previamente para contar con datos locales.
      </footer>
    </section>
  );
}
